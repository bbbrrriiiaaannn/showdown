(function (global, factory) {
  ...
  (global = global || self, global.showdown = factory());
  ...
  var helpers = /*#__PURE__*/Object.freeze({
    ...
    forEach: forEach,
    stdExtName: stdExtName,
    escapeCharactersCallback: escapeCharactersCallback,
    escapeCharacters: escapeCharacters,
    matchRecursiveRegExp: matchRecursiveRegExp,
    replaceRecursiveRegExp: replaceRecursiveRegExp,
    regexIndexOf: regexIndexOf,
    splitAtIndex: splitAtIndex,
    encodeEmailAddress: encodeEmailAddress,
    padEnd: padEnd,
    unescapeHTMLEntities: unescapeHTMLEntities,
    _hashHTMLSpan: _hashHTMLSpan,
    Event: Event,
    regexes: regexes,
    emojis: emojis
  });
   ...
   */
  function detab (text, options, globals) {
   ...
   */
  function encodeCode (text, options, globals) {
  ...
  function hashBlock (text, options, globals) {
   ...
   * ```
   */
  function githubCodeBlocks (text, options, globals) {
  ...
  function blockQuotes (text, options, globals) {
   ...
   */
  function outdent (text, options, globals) {
   ...
   */
  function codeBlocks (text, options, globals) {
  ...
  function hashElement (text, options, globals) {
  ...
  function hashHTMLBlocks (text, options, globals) {
   ...
   */
  function hashHTMLSpans (text, options, globals) {
   ...
   *         ... type <code>`bar`</code> ...
   */
  function codeSpans (text, options, globals) {
  ...
  function ellipsis (text, options, globals) {
   ...
   */
  function emoji (text, options, globals) {
   ...
   */
  function encodeAmpsAndAngles (text, options, globals) {
   ...
   */
  function encodeBackslashEscapes (text, options, globals) {
   ...
   */
  function escapeSpecialCharsWithinTagAttributes (text, options, globals) {
   ...
   */
  function images (text, options, globals) {
  ...
  function italicsAndBold (text, options, globals) {
  ...
  function underline (text, options, globals) {
  ...
  function strikethrough (text, options, globals) {
   ...
   */
  function unescapeSpecialChars (text, options, globals) {
  ...
  function writeAnchorTag (evt, options, globals, emptyCase) {
    ...
    result = hashHTMLSpans(result, options, globals);
   ...
   */
  function linksParser (text, options, globals) {
   ...
   */
  function spanGamut (text, options, globals) {
  ...
  function headers (text, options, globals) {
    ...
    text = text.replace(setextRegexH1, function (wholeMatch, m1) {
      ...
      var spanGamut$1 = spanGamut(m1, options, globals),
          hID = (options.noHeaderId) ? '' : ' id="' + headerId(m1) + '"',
          hLevel = headerLevelStart,
          hashBlock$1 = '<h' + hLevel + hID + '>' + spanGamut$1 + '</h' + hLevel + '>';
      return hashBlock(hashBlock$1, options, globals);
    });
    ...
    text = text.replace(atxStyle, function (wholeMatch, m1, m2) {
      ...
      var span = spanGamut(hText, options, globals),
   ...
   *
   */
  function paragraphs (text, options, globals) {
      ...
      while (/¨(K|G)(\d+)\1/.test(grafsOutIt)) {
        ...
        if (delim === 'K') {
          ...
          if (codeFlag) {
            ...
            blockText = encodeCode(globals.ghCodeBlocks[num].text, options, globals);
          } else {
   ...
   */
  function listsParser (text, options, globals) {
    ...
    function processListItems (listStr, trimTrailing) {
      ...
      listStr = listStr.replace(rgx, function (wholeMatch, m1, m2, m3, m4, taskbtn, checked) {
        ...
        var item = outdent(m4, options, globals),
            bulletStyle = '';
  ...
  function tables (text, options, globals) {
    ...
    function parseCells (cell, style) {
      var subText = spanGamut(cell, options, globals);
   ...
   * tags like paragraphs, headers, and list items.
   */
  function blockGamut (text, options, globals) {
   ...
   */
  function completeHTMLDocument (text, options, globals) {
   ...
   */
  function hashCodeTags (text, options, globals) {
    text = globals.converter._dispatch('makehtml.hashCodeTags.before', text, options, globals).getText();

    var repFunc = function (wholeMatch, match, left, right) {
      var codeblock = left + encodeCode(match, options, globals) + right;
   ...
   */
  function hashPreCodeTags (text, options, globals) {
   ...
   */
  function metadata (text, options, globals) {
   ...
   * Run extension
   */
  function runExtension (ext, text, options, globals) {
   ...
   */
  function stripLinkDefinitions (text, options, globals) {
    ...
    var replaceFunc = function (wholeMatch, linkId, url, width, height, blankLines, title) {
      ...
      if (url.match(/^data:.+?\/.+?;base64,/)) {
        ...
        globals.gUrls[linkId] = encodeAmpsAndAngles(url, options, globals);  // Link IDs are case-insensitive
      }
   ...
   * Unhash HTML spans
   */
  function unhashHTMLSpans (text, options, globals) {
  ...
  var makehtml = /*#__PURE__*/Object.freeze({
    blockGamutParser: blockGamut,
    blockQuotesParser: blockQuotes,
    codeBlocksParser: codeBlocks,
    codeSpansParser: codeSpans,
    completeHTMLDocumentParser: completeHTMLDocument,
    detabParser: detab,
    ellipsisParser: ellipsis,
    emojiParser: emoji,
    encodeAmpsAndAnglesParser: encodeAmpsAndAngles,
    encodeBackslashEscapesParser: encodeBackslashEscapes,
    encodeCodeParser: encodeCode,
    escapeSpecialCharsWithinTagAttributesParser: escapeSpecialCharsWithinTagAttributes,
    githubCodeBlocksParser: githubCodeBlocks,
    hashBlockParser: hashBlock,
    hashCodeTagsParser: hashCodeTags,
    hashElementParser: hashElement,
    hashHTMLBlocksParser: hashHTMLBlocks,
    hashHTMLSpansParser: hashHTMLSpans,
    hashPreCodeTagsParser: hashPreCodeTags,
    headersParser: headers,
    horizontalRuleParser: horizontalRule,
    imagesParser: images,
    italicsAndBoldParser: italicsAndBold,
    linksParser: linksParser,
    listsParser: listsParser,
    metadataParser: metadata,
    outdentParser: outdent,
    paragraphsParser: paragraphs,
    runExtensionParser: runExtension,
    spanGamutParser: spanGamut,
    strikethroughParser: strikethrough,
    stripLinkDefinitionsParser: stripLinkDefinitions,
    tablesParser: tables,
    underlineParser: underline,
    unescapeSpecialCharsParser: unescapeSpecialChars,
    unhashHTMLSpansParser: unhashHTMLSpans
  });

  function codeBlockParser (node, globals) {
  ...
  function codeSpanParser (node) {

    return '`' + node.innerHTML + '`';
  }

  function emphasisParser (node, globals) {
  ...
  function headerParser (node, globals, headerLevel) {
  ...
  function linksParser$1 (node, globals) {
  ...
  function listItemParser (node, globals) {
  ...
  function listParser (node, globals, type) {
  ...
  function paragraphParser (node, globals) {
  ...
  function preParser (node, globals) {

    var num  = node.getAttribute('prenum');
    return '<pre>' + globals.preList[num] + '</pre>';
  }

  function strikethroughParser (node, globals) {
  ...
  function strongParser (node, globals) {
  ...
  function tableCellParser (node, globals) {
  ...
  function tableParser (node, globals) {
  ...
  function nodeParser (node, globals, spansOnly) {
    ...
    switch (tagName) {
      ...
      case 'a':
        txt = linksParser$1(node, globals);
        break;
  ...
  function blockquoteParser (node, globals) {
  ...
  var makemarkdown = /*#__PURE__*/Object.freeze({
    default: index
  });
  ...
  const Converter = function (converterOptions) {
    ...
    function _constructor () {
      ...
      if (options.extensions) {
        forEach(options.extensions, _parseExtension);
      }
    }
    ...
    function _parseExtension (ext, name) {
      ...
      if (isString(ext)) {
        ...
        } else if (!isUndefined(globalProps.extensions[ext])) {
    ...
    this.makeHtml = function (text) {
      ...
      forEach(langExtensions, function (ext) {
        text = runExtension(ext, text, options, globals);
      });

      // run the sub parsers
      text = metadata(text, options, globals);
      ...
      text = completeHTMLDocument(text, options, globals);

      // Run output modifiers
      forEach(outputModifiers, function (ext) {
        text = runExtension(ext, text, options, globals);
      });

      // update metadata
      metadata$1 = globals.metadata;
      return text;
    };
    ...
    this.getMetadata = function (raw) {
      if (raw) {
        return metadata$1.raw;
      } else {
        return metadata$1.parsed;
      }
    };
   ...
   * @returns {showdown}
   */
  showdown$1.setOption = function (key, value) {
   ...
   * @returns {*}
   */
  showdown$1.getOption = function (key) {
   ...
   * @returns {{}}
   */
  showdown$1.getOptions = function () {
   ...
   * @static
   */
  showdown$1.resetOptions = function () {
   ...
   * @param {string} name
   */
  showdown$1.setFlavor = function (name) {
    if (!globalProps.flavor.hasOwnProperty(name)) {
      throw Error(name + ' flavor was not found');
    }
    showdown$1.resetOptions();
    var preset = globalProps.flavor[name];
   ...
   * @returns {{}|undefined}
   */
  showdown$1.getFlavorOptions = function (name) {
    if (globalProps.flavor.hasOwnProperty(name)) {
   ...
   * @returns {{}}
   */
  showdown$1.getDefaultOptions = function (simple) {
   ...
   * @returns {*}
   */
  showdown$1.subParser = function (name, func) {
    if (showdown$1.helper.isString(name)) {
   ...
   * @returns {*}
   */
  showdown$1.extension = function (name, ext) {

    if (!showdown$1.helper.isString(name)) {
      throw Error('Extension \'name\' must be a string');
    }

    name = showdown$1.helper.stdExtName(name);

    // Getter
    if (showdown$1.helper.isUndefined(ext)) {
      ...
      if (!showdown$1.helper.isArray(ext)) {
        ext = [ext];
      }

      var validExtension = validate$1(ext, name);
   ...
   * @returns {{}}
   */
  showdown$1.getAllExtensions = function () {
   ...
   * @param {string} name
   */
  showdown$1.removeExtension = function (name) {
   ...
   */
  showdown$1.resetExtensions = function () {
   ...
   */
  function validate$1 (extension, name) {
    ...
    if (!showdown$1.helper.isArray(extension)) {
      extension = [extension];
    }
    ...
    for (var i = 0; i < extension.length; ++i) {
      ...
      if (!showdown$1.helper.isString(ext.type)) {
        ret.valid = false;
      ...
      if (type === 'listener') {
        if (showdown$1.helper.isUndefined(ext.listeners)) {
          ret.valid = false;
          ret.error = baseMsg + '. Extensions of type "listener" must have a property called "listeners"';
          return ret;
        }
      } else {
        if (showdown$1.helper.isUndefined(ext.filter) && showdown$1.helper.isUndefined(ext.regex)) {
          ret.valid = false;
      ...
      if (ext.filter) {
        ...
        if (showdown$1.helper.isString(ext.regex)) {
        ...
        if (showdown$1.helper.isUndefined(ext.replace)) {
          ret.valid = false;
   ...
   * @returns {boolean}
   */
  showdown$1.validateExtension = function (ext) {

    var validateExtension = validate$1(ext, null);
  ...
  showdown$1.helper = helpers;
  Object.keys(makehtml).forEach(subparserId => {
    showdown$1.subParser(`makehtml.${subparserId}`, makehtml[subparserId]);
  });
  Object.keys(makemarkdown).forEach(subparserId => {
    showdown$1.subParser(`makemarkdown.${subparserId}`, makemarkdown[subparserId]);
  });
  showdown$1.Converter = Converter;
